...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        return getId() == student.getId() && getAge() == student.getAge() && Objects.equals(getName(), student.getName()) && getDegree() == student.getDegree();
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getName(), getAge(), getDegree());
    }
}